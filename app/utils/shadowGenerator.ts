...
export const shadowGenerator = (depth):ViewStyle => {
    ...
    return {
      ...
      shadowRadius: parseFloat(interpolate(s.blur, 1, 38, 1, 16).toFixed(2)),
      shadowOpacity: parseFloat(interpolate((depth - 1), 1, 24, 0.2, 0.6).toFixed(2)),
      elevation: depth
    }
}
