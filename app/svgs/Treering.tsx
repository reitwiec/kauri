  ...
  return (
    <View style={{aspectRatio: 1}}>
      ...
      {Array.from({length: total}).map((i, j)=>{
                        ...
                        return (
                            <Path key={j} d="M35.7,18l-1.2,0.1l-0.8,0.4 c0,0-1.1,0-1.1,0c-1.7,0.3-3.5,0.7-4.9,1.7c-0.2,0.1-0.4,0.3-0.6,0.4 c-0.2,0.1-0.4,0.2-0.6,0.3c-1,0.4-1.9,0.9-2.8,1.4c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.1-0.2,0.3-0.2,0.4c-0.1,0.2-0.2,0.4-0.4,0.6
