...
export const ProductDetail:FC<ProductDetailProps> = (_props) => {
    ...
    useEffect(() => {
      setProductImages(productDetails.productImages[0])
      setVariant(0)
      variantVal.value = 0
      setSize(0)
    }, [])
        ...
        <View style={[$container]}>
            ...
            <ScrollView style={{flex: 1, paddingTop: $containerInsets.paddingTop, backgroundColor: '#000'}} bounces={false}>
                <View>
                    ...
                    {isBusy && <View style={{position: 'absolute', bottom:0, top:0, right:0, left:0, borderTopLeftRadius:32, borderTopRightRadius: 32, backgroundColor: hexToRGBA(kauriColors.primary.light, 0.8), alignItems: 'center', justifyContent: 'center'}}>
            ...
            <CrossBtn/>
            <TouchableOpacity activeOpacity={0.9} style={{position: 'absolute', top: $containerInsets.paddingTop?Number($containerInsets.paddingTop)+4:16, left: 16, backgroundColor: hexToRGBA(kauriColors.primary.chipBar, 0.3), padding:6, borderRadius: 24}}>
                <CartIcon/>
