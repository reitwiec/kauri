...
import { shopChips } from "../../mockdata";
...
export const Shop:FC<ShopProps> = observer(function Shop(_props){
    ...
    return (
        <View style={[$container, $containerInsets]}>
            ...
            <RiveHeader translationY={translationY} data={shopChips} config={{right: ['wishlist','cart'],left:["filter", "search"], height: riveHeight}} screenState={updateShopState} isSearching={isSearching} searchClicked={searchClicked} updateSearchPhrase={updateSearchPhrase}/>
        </View>
    )
})
