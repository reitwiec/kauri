            ...
            <>
                ...
                <LinearGradient style={{borderRadius:12, padding:16, borderColor: "rgba(240,115,116, 0.67)", borderWidth: 1, alignItems: 'center', marginHorizontal: 16, marginTop: 24}}
                        ...
                        >
                            ...
                            }} style={{backgroundColor: '#fff', borderRadius: 12, paddingHorizontal:32, paddingVertical: 16, alignItems: 'center', marginTop: 24}}>
                                <Text style={{...designSystem.textStyles.smallTextsBold, color: "rgba(240,115,116,1)"}}>
                                    Generate your Trail
                                </Text>
                            </TouchableOpacity>
                </LinearGradient>
