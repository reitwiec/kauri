...
export const CrossBtn = () => {
    ...
    return (
        <View style={{ position: 'absolute', top: $containerInsets.paddingTop?Number($containerInsets.paddingTop)+4:16, right: 16, backgroundColor: hexToRGBA(kauriColors.primary.chipBar, 0.7), padding:6, borderRadius: 24}}>
